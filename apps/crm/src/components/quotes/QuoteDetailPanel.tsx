            ...
            {quote.status === 'draft' && (
              <div className="flex flex-wrap gap-2 p-3 rounded-lg" style={{ background: 'color-mix(in srgb, var(--sys-primary) 6%, transparent)', border: '1px solid color-mix(in srgb, var(--sys-primary) 15%, transparent)' }}>
                ...
                <Button
                  ...
                  className="gap-1"
                >
                  {statusLoading === 'sent' ? <span className="spinner" /> : <Send size={14} />}
                  Marcar como Enviada
                </Button>
                <Button
                  variant="ghost"
            ...
            {quote.status === 'sent' && (
              <div className="flex flex-wrap gap-2 p-3 rounded-lg" style={{ background: 'color-mix(in srgb, var(--sys-primary) 6%, transparent)', border: '1px solid color-mix(in srgb, var(--sys-primary) 15%, transparent)' }}>
                ...
                <Button
                  ...
                  className="gap-1"
                >
                  {statusLoading === 'accepted' ? <span className="spinner" /> : <CheckCircle size={14} />}
                ...
                <Button
                  ...
                  className="gap-1"
                >
                  {statusLoading === 'rejected' ? <span className="spinner" /> : <XCircle size={14} />}
