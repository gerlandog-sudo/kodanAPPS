...
import { B2BAccountsList } from './B2BAccountsList';
import { B2BAccountForm } from './B2BAccountForm';
...
export function B2BAccountsPage({
  deleteWarningMessage = '¿Está seguro de eliminar esta cuenta?',
}: B2BAccountsPageProps) {
