          ...
          <div className="entity-card-actions" style={{
            ...
            {onChat && (
              <button type="button" onClick={(e) => { e.stopPropagation(); onChat() }}
                ...
                style={{ padding: '0.125rem', background: 'transparent', border: 'none', cursor: 'pointer', display: 'flex', color: 'inherit', transition: 'all 120ms ease' }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'var(--sys-surface)' }}
            ...
            {onDelete && (
              <button type="button" onClick={(e) => { e.stopPropagation(); onDelete() }}
                title="Eliminar"
                style={{ padding: '0.125rem', background: 'transparent', border: 'none', cursor: 'pointer', display: 'flex', color: 'var(--sys-text-muted)', transition: 'all 120ms ease' }}
