        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem', fontSize: '12px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontWeight: 700, color: 'var(--sys-text)' }}>{Math.round(Number(budgetHours))}h</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'var(--sys-text-muted)' }}>Consumido</span>
              <span style={{ fontWeight: 700, color: 'var(--sys-text)' }}>{Math.round(Number(actualHours))}h</span>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{ 
                ...
                {Math.round(remainingHours)}h ({percentRemaining}%)
              </span>
            </div>
          </div>
        </div>
